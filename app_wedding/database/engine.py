...
# []
# description_for_quiz = {
#     'season': 'Выбор сезона за Вами!',
#     'amount': 'Количество приглашенных гостей',
#     'place': 'Ваше волшебное место',
#     'style': 'Стиль',
#     'colors': 'Цветовая палитра',
#     'fashion': 'Фасон платья',
#     'costume': 'Фасон костюма',
#     'end': 'Все почти готово',
# }
